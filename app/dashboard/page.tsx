...
const DashboardPage = () => {
  ...
  const { data, isLoading, isFetching } = useGetChallengesQuery(
    { limit: 3, page: 1, search: searchParam },
  ...
  } = useGiveChallengeStatisticsQuery({}, { skip: !isAdmin });
  ...
  const statistics = [
    {
      title: 'Completed',
      value:
        participantChallenges?.data.aggregates.totalCompletedChallenges || 0,
    },
    {
      title: 'Open',
      value: participantChallenges?.data.aggregates.totalOpenChallenges || 0,
    },
    {
      title: 'Ongoing',
      value: participantChallenges?.data.aggregates.totalOngoingChallenges || 0,
    },
    {
      title: 'Closed',
  ...
  const adminStatData = [
    ...
    },
    {
      ...
      direction: String(
        statisticsData?.data?.totalOpenChallengesChangeDirection || 'negative'
      ),
    },
    {
  ...
  return (
    <div className="px-2">
      ...
      {isLoading ||
        ...
        <NoChallengeFound isAdmin={isAdmin} />
      )}
    </div>
  );
};
